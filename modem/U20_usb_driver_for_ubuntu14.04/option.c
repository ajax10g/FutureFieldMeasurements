...
#if 1 //add by Quectel If GobiNet or QMI WWAN is required, add next statements
       //Quectel UC20's interface 4 can be register as USB Net device
    	if (serial->dev->descriptor.idVendor == 0x05C6 && serial->dev->descriptor.idProduct == 0x9003
            && serial->interface->cur_altsetting->desc.bInterfaceNumber == 4)
		return -ENODEV;
 
       //Quectel EC20's interface 4 can be register as USB Net device
